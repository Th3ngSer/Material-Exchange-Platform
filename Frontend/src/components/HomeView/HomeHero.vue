...
<template>
  <section class="bg-[#131138] shadow-[0_28px_70px_rgba(14,18,31,0.35)]">
    <div
      class="relative mx-auto grid max-w-[1600px] min-h-[560px] grid-cols-[minmax(0,1fr)_minmax(430px,1fr)] max-[960px]:min-h-0 max-[960px]:grid-cols-1"
    >
      <div
