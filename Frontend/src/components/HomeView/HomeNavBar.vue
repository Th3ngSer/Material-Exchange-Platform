...
<template>
  <header class="sticky top-0 z-20 border-b border-[#22245f1a] bg-white">
    <div class="mx-auto grid min-h-[66px] w-full max-w-[1920px] grid-cols-[auto_auto_1fr_auto] items-center gap-3 px-3 py-1 max-[1100px]:grid-cols-1 max-[1100px]:gap-2">
      <a class="inline-flex items-baseline text-[32px] font-extrabold tracking-[-0.04em] no-underline" href="/" aria-label="Material Exchange Platform home">
      ...
      <form class="mx-auto grid w-full max-w-[452px] grid-cols-[118px_1fr_42px] items-center overflow-hidden rounded-[8px] border border-[#2b2f9161] bg-[#f4f5fb] max-[1100px]:max-w-none max-[1100px]:justify-self-stretch" role="search">
        ...
        <select id="home-search-type" aria-label="Search type" class="appearance-none border-0 border-r border-[#2b2f912e] bg-transparent px-3 text-[#7b7c98] outline-none">
        ...
        <button type="submit" aria-label="Search" class="grid h-[34px] w-[42px] place-items-center border-0 bg-transparent text-[#201f62]">
      ...
      <div class="inline-flex items-center justify-self-end gap-2">
        <button class="grid h-[34px] w-[34px] place-items-center rounded-full border-0 bg-transparent text-[#201f62]" type="button" aria-label="Messages">
          <svg viewBox="0 0 24 24" aria-hidden="true" class="h-[25px] w-[25px] fill-current">
            <path d="M20 4H4a2 2 0 0 0-2 2v13.17L5.17 16H20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Zm0 10H4.34L4 14.34V6h16v8Z" />
          </svg>
        </button>
        <button class="grid h-[34px] w-[34px] place-items-center rounded-full border-0 bg-transparent text-[#201f62]" type="button" aria-label="Notifications" @click="goToNotifications">
          <svg viewBox="0 0 24 24" aria-hidden="true" class="h-[25px] w-[25px] fill-current">
