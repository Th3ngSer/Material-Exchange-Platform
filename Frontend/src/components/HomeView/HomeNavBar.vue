...
<template>
  <header class="sticky top-0 z-20 border-b border-[#22245f1a] bg-white">
    ...
    >
      <a
        class="inline-flex items-baseline text-[32px] font-extrabold tracking-[-0.04em] no-underline"
        href="/"
      ...
      >
        ...
        <select
          ...
          class="appearance-none border-0 border-r border-[#2b2f912e] bg-transparent px-3 text-[#7b7c98] outline-none"
        >
        ...
        <button
          type="submit"
          aria-label="Search"
          class="grid h-[34px] w-[42px] place-items-center border-0 bg-transparent text-[#201f62]"
        >
      ...
      <div class="inline-flex items-center justify-self-end gap-2">
        <button
          class="grid h-[34px] w-[34px] place-items-center rounded-full border-0 bg-transparent text-[#201f62]"
          type="button"
          aria-label="Messages"
        >
          <svg viewBox="0 0 24 24" aria-hidden="true" class="h-[25px] w-[25px] fill-current">
