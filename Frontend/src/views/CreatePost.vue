...
<template>
  <div class="min-h-screen bg-[#F7FDFE] px-4 py-10">
    ...
    <div v-if="step === 1" class="max-w-2xl mx-auto space-y-5">
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-black-900">Let's release your new product</h1>
        <p class="text-black-800 text-sm mt-1">Fill in the details below to list your item</p>
      </div>
    ...
    <div v-if="step === 2" class="max-w-sm mx-auto">
      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-gray-100">
        ...
        <div class="relative">
          ...
          <!-- Dot indicators -->
          <div v-if="previewUrls.length > 1" class="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-1.5">
            <button
              v-for="(_, i) in previewUrls" :key="i"
              @click="activeThumb = i"
        ...
        <!-- Thumbnail row -->
        <div v-if="previewUrls.length > 1" class="flex gap-2 px-3 py-2 border-b border-[#666565] overflow-x-auto">
          <img
            v-for="(url, i) in previewUrls" :key="i"
            :src="url" @click="activeThumb = i"
        ...
        <div class="px-5 pt-4 pb-5 space-y-3">
          ...
          <div class="flex items-start justify-between gap-2">
            ...
            <span class="text-xs font-semibold px-3 py-1 rounded-full flex-shrink-0 mt-0.5" :class="typeBadgeClass">
              {{ form.type }}
            </span>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs font-semibold px-2.5 py-1 rounded-full" :class="conditionBadgeClass">
              {{ form.condition }}
            </span>
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <button class="flex items-center gap-1.5 bg-blue-100 hover:bg-gray-200 text-black text-xs font-semibold px-3 py-2 rounded-full transition">
              💬 Contact Me
            </button>
          </div>
          ...
          <div class="text-center py-1">
            ...
            <p class="text-gray-400 text-xs uppercase tracking-wider mt-0.5">Verified studio address</p>
          </div>
